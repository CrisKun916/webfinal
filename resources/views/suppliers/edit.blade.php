      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body">
                <h5 class="card-title">Edit Supplier</h5><br>
                <a href="{{ route('suppliers.index') }}" class="btn btn-sm btn-primary"> <i class="fa fa-arrow-left"></i> Back</a><br><br>
                <form role="form" action="{{route('suppliers.update',$suppliers->id) }}" method="post">
                  @csrf
                  @method('PUT')
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input name="phone_number" type="tel" class="form-control" placeholder="Enter Phone Number">
