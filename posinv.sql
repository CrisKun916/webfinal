...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2021 at 10:58 PM
...
(31, '2021_06_01_081904_create_categories_table', 1),
(32, '2021_06_01_082652_create_locations_table', 1),
(33, '2021_06_01_084638_create_suppliers_table', 1),
(34, '2021_06_03_064325_create_products_table', 1),
(35, '2021_06_04_072901_create_transactions_table', 1),
(36, '2021_06_04_073334_create_product_transaction_table', 1);
...
CREATE TABLE `transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `cust_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `suppliers`
  ADD CONSTRAINT `suppliers_location_id_foreign` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
